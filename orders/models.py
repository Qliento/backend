...
class Statistics(models.Model):
    ...
    demo_downloaded = models.ForeignKey(StatisticsDemo, default=1, null=True, blank=True, on_delete=models.CASCADE, related_name='demos_downloaded', verbose_name="Количество скачанных демо-версий")
    watches = models.ForeignKey(StatisticsWatches, default=1, null=True, blank=True, on_delete=models.CASCADE, related_name='watches_counted', verbose_name="Количество просмотров")
    bought = models.ForeignKey(StatisticsBought, default=1, null=True, blank=True, on_delete=models.CASCADE, related_name='bought_researches', verbose_name="Количество скачиваний")
